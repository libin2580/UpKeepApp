...
public class CalendarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MainFragment.title_new1.setText("Calendar");
...
*/
    ...
    private void initializeCalendar()
    {
        ...
        calendarView.setSelectedWeekBackgroundColor(getResources().getColor(R.color.colorred));
        calendarView.setUnfocusedMonthDateColor(getResources().getColor(R.color.colorAccent));
        calendarView.setWeekSeparatorLineColor(getResources().getColor(R.color.colorblue));
        calendarView.setSelectedDateVerticalBar(R.color.colorred);
