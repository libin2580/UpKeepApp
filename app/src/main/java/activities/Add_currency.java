...
/**
 * Created by SIDDEEQ DESIGNER on 2/16/2018.
 */
...
public class Add_currency extends AppCompatActivity
{
    ...
    private String[] arr = {"United States dollar-USD","British pound-GBP", "Euro-EUR", "Chinese yuan-CNY", "Japanese yen-JPY","South Korean won-KRW", "South African rand-ZAR", "Thai baht-THB", "Indian Rupee-INR", "United Arab Emirates, Dirham-AED","Saudi Arabian, Riyal-SAR","Kuwaiti,Dinar-KWD",
    "Malasian, Ringgit-MYR","Australian Dollar-AUD","New Zealand Dollar-NZD","Indonesian,Rupiah-IDR"};
    TextView title,save;
    ImageView backarrow;
